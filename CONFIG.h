...
#define STEPPER_RUN_DIODE_PIN     7      // номер пина, куда подключается светодиод индикации работы шагового
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define LEFT_BUTTON_PIN   A9 // пин кнопки "Влево"
#define RIGHT_BUTTON_PIN  A8 // пин кнопка "Вправо"
