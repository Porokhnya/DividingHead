...
#define ENCODER_B_PIN       A10 // пин вывода В энкодера
...
#define MAX_SPEED               15 // оборотов в минуту
#define STEP_PULSE_WIDTH        10 // ширина импульса STEP, микросекунд (зависит от используемого драйвера)
